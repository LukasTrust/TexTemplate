...
\captionof{figure}{Schematic of the processing pipeline. Patch partitioning and quad mesh generation lead to a feature field construction. The field is sampled, deformed using an MLP and converted into the final mesh output.}
\label{fig:teaser}
