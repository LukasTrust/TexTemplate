...
The following section describes how this patch-based representation is used to generate detailed geometry through a neural deformation model, including the role of tessellation, feature encoding and the architecture of the Multilayer Perceptron.  
...
\begin{figure}
  \centering
  \begin{adjustbox}{center}
  \begin{tikzpicture}[scale=0.85, >={Stealth[scale=0.4]}, line width=0.5pt]
  ...
  \begin{scope}[xshift=0cm, yshift=0cm]
    ...
    \node at (1,-0.7) {\small \textbf{(a)} Original Sampling};

    % 6 Random original points
    \filldraw[red] (0.4,1.2) circle (2pt);
    \filldraw[red] (1.5,1.6) circle (2pt);
    \filldraw[red] (1.1,0.5) circle (2pt);
    \filldraw[red] (0.8,0.9) circle (2pt);
    \filldraw[red] (0.3,0.4) circle (2pt);
    \filldraw[red] (1.6,0.8) circle (2pt);
  \end{scope}

  % Arrow to next square
  \draw[->, thick] (2.6,0.7) -- (5.0,0.7) node[midway, above] {Jitter};
  ...
  \begin{scope}[xshift=5.5cm, yshift=0cm]
    ...
    \filldraw[black] (0,2) circle (1pt);
    \filldraw[black] (2,2) circle (1pt);
    \node at (1,-0.7) {\small \textbf{(b)} Jittered Sampling};

    % Original points in gray
    \filldraw[gray] (0.4,1.2) circle (2pt);
    \filldraw[gray] (1.5,1.6) circle (2pt);
    \filldraw[gray] (1.1,0.5) circle (2pt);
    \filldraw[gray] (0.8,0.9) circle (2pt);
    \filldraw[gray] (0.3,0.4) circle (2pt);
    \filldraw[gray] (1.6,0.8) circle (2pt);

    % Jittered points (stronger jitter)
    \filldraw[red] (0.55,1.05) circle (2pt);
    \filldraw[red] (1.68,1.78) circle (2pt);
    \filldraw[red] (0.95,0.35) circle (2pt);
    \filldraw[red] (0.65,0.75) circle (2pt);
    \filldraw[red] (0.45,0.25) circle (2pt);
    \filldraw[red] (1.78,0.65) circle (2pt);

    % Arrows from gray to red points
    \draw[->, gray] (0.4,1.2) -- (0.55,1.05);
    \draw[->, gray] (1.5,1.6) -- (1.68,1.78);
    \draw[->, gray] (1.1,0.5) -- (0.95,0.35);
    \draw[->, gray] (0.8,0.9) -- (0.65,0.75);
    \draw[->, gray] (0.3,0.4) -- (0.45,0.25);
    \draw[->, gray] (1.6,0.8) -- (1.78,0.65);
  \end{scope}
...
To reconstruct high-fidelity surface geometry, the model employs a neural deformation module based on a multi-layer perceptron (MLP).  
