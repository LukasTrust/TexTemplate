...
Table~\ref{tab:ngf-times} summarizes the runtime performance of the inverse rendering pipeline, highlighting the method's efficiency in both surface extraction and multi-view training.
